...
![1639653356(1).png](https://upload-images.jianshu.io/upload_images/14502986-4f4bf07e798eb416.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
- `.m:`
  ...
  如下图：
  ![1639654416(1).png](https://upload-images.jianshu.io/upload_images/14502986-f2e3c34699b64dec.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

##### 2.2. XHR 断点 + 跟栈

我们也可以打一个 `Any XHR or fetch` 断点，然后在翻页的时候让网页断下来。

![1639655380(1).png](https://upload-images.jianshu.io/upload_images/14502986-219d1301e9a76d5e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

之后在 `Call Stack` 中跟栈分析，通过分析发现在 `window.request` 位置 `m` 出现了。
如下图：
![1639655597(1).png](https://upload-images.jianshu.io/upload_images/14502986-f6e17e82b12a7e50.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
如下图：
![1639667176(1).png](https://upload-images.jianshu.io/upload_images/14502986-2840d157b34e4b2f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

接下来，使用此参数发送请求，尝试获取数据，但是却一直无法成功返回数据。
使用 fiddler 抓包，发现此时服务器返回了 `301错误`。
如下图：

![1639727622(1).png](https://upload-images.jianshu.io/upload_images/14502986-91871197c719703b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![1639728602(1).png](https://upload-images.jianshu.io/upload_images/14502986-825e0b90274c3b4f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

##### 4.3. 修改代码
此处，将 `n.g` 修改为 `window`。
重新执行本地文件，并发送请求，发现成功获取返回值。
如下图：
![1639728838(1).png](https://upload-images.jianshu.io/upload_images/14502986-f196bf037c78a872.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

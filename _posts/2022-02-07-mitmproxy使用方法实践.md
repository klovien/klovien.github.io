...
![安装成功后的界面]({{site.baseurl}}/img-post/mitm-1.jpg)
...
![mitmproxy服务器绑定了 *:8080作为代理端口]({{site.baseurl}}/img-post/mitm-2.jpg)

此时，浏览器自动打开下图页面，这是 mitmproxy 提供的 web 交互界面。
![上图为mitmproxy自动打开的web交互界面]({{site.baseurl}}/img-post/mitm-3.jpg)
...
![WeChatd8d30030a2bf45bb1071f0f136698471.png]({{site.baseurl}}/img-post/mitm-4.jpg)
第三步，给手机WiFi配置代理
- 服务器地址为电脑内网IP地址，端口为8080
  ![服务器地址为电脑内网IP地址，端口为8080]({{site.baseurl}}/img-post/mitm-5.jpg)
  第四步，安装证书

使用手机浏览器访问 mitm.it，得到下图。

![选择自己的手机系统]({{site.baseurl}}/img-post/mitm-6.jpg)

我的手机为iPhone，点击 Apple 后得到下图。

![31543663396_.pic.jpg]({{site.baseurl}}/img-post/mitm-7.jpg)

点击允许，开始安装，安装完成后，得到已验证的提示。

![61543663399_.pic.jpg]({{site.baseurl}}/img-post/mitm-8.jpg)

### 2.4. 开启证书

手机依次点击：**设置** -> **通用** -> **关于本机** -> **证书信任设置**，开启 mitmproxy 证书。

![微信图片编辑_20200207211352.jpg]({{site.baseurl}}/img-post/mitm-9.jpg)
...
![红框中的为 mitmproxy 抓取的手机的请求]({{site.baseurl}}/img-post/mitm-10.jpg)
...
- 启动 APP
  ...
  ![image.png]({{site.baseurl}}/img-post/mitm-11.jpg)
